                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className={cn(
                          ...
                          agent.status === 'active' ? "bg-blue-50 text-blue-700 border-blue-200" :
                          agent.status === 'reviewing' ? "bg-purple-50 text-purple-700 border-purple-200" :
                          agent.status === 'approved' ? "bg-emerald-50 text-emerald-700 border-emerald-200" :
                          agent.status === 'waiting_on_subordinates' ? "bg-amber-50 text-amber-700 border-amber-200" :
