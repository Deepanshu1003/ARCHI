...
class ToolBuilderAgent:
    """
    Tool Builder Agent.
    Creates specialized developer tools, API integration wrappers, and linter checkers.
    """

    def __init__(
        self, 
        agent_id: str = None, 
        person_name: str = "Grace", 
        role_name: str = "Specialized Tool Engineer",
        responsibilities: str = "Build automated tools, SDK integrations, and syntax validators.",
    ...
    def receive_instruction(self, message: str, supervisor_decisions: str = "") -> str:
        ...
        system_prompt = (
            ...
            f"Generate technical tool specifications, API wrappers, or linter rules."
        )
