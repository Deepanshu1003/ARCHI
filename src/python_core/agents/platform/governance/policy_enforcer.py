...
class GovernanceAgent:
    """
    Governance & Policy Auditor Agent.
    Audits safety rules, API rate limits, access controls, and policy compliance.
    """

    def __init__(
        self, 
        agent_id: str = None, 
        person_name: str = "Frank", 
        role_name: str = "Governance & Policy Auditor",
        responsibilities: str = "Enforce security policies, API rate limits, and safety guidelines.",
    ...
    def receive_instruction(self, message: str, supervisor_decisions: str = "") -> str:
        ...
        system_prompt = (
            ...
            f"Audit safety compliance, access rules, and policy boundaries."
        )
