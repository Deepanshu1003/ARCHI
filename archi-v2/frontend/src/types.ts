/** Lowercase mirror of the backend AgentStatus enum. */
export type AgentStatus = 'idle' | 'drafting' | 'delegated' | 'awaiting_review' | 'approved';
...
export type DocType = 'principles' | 'plan';

export interface AgentDoc {
  id: string;
  title: string;
  filename: string;
  category: DocType | string;
  docType?: string;
  content: string;
  updatedAt: number;
  version?: number;
